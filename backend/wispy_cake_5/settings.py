"""
Django settings for wispy_cake_5 project.
...
ROOT_URLCONF = 'wispy_cake_5.urls'
...
WSGI_APPLICATION = 'wispy_cake_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_cake_5 API",
    "DESCRIPTION": "API documentation for wispy_cake_5 App",
    "VERSION": "v1",
}
